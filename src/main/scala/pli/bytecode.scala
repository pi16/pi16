...
class Bytecode {
  ...
  /**
   * Appends an `zor` instruction and returns the adress of the
   * newly added instructon.
   */
  def zor() =
    append(Opcode.zor)
  ...
  /**
   * Appends an `zoror` instruction and returns the adress of the
   * newly added instructon.
   */
  def zoror() =
    append(Opcode.zoror)
  ...
  /**
   * Appends an `zand` instruction and returns the adress of the
   * newly added instructon.
   */
  def zand() =
    append(Opcode.zand)
  ...
  /**
   * Appends an `zandnad` instruction and returns the adress of the
   * newly added instructon.
   */
  def zandand() =
    append(Opcode.zandand)

  /**
   * Appends an `equalsequals` instruction and returns the adress of the
   * newly added instructon.
   */
  def equalsequals() =
    append(Opcode.equalsequals)

  /**
   * Appends an `zconst` instruction and returns the adress of the
   * newly added instructon.
   */
  def zconst(value: Int) = {

    if (value == Opcode.ztrue) {
      val result = append(Opcode.ztrue)
      append(value)
      result
    } else {
      val result = append(Opcode.zfalse)
      append(value)
      result
    }
